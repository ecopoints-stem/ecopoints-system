...
interface IPickupRequestService {
    ...
    fun findAllByCoopAdminId(cooperativeAdminId: Long, pageable: Pageable) : Page<RecyclingPickupRequest>
    ...
    fun findAllByRequesterIdAndClientIdAndStatusIn(coopAdminId: Long, requesterId: Long, statuses: List<PickupRequestStatus>, startDate: LocalDate, endDate: LocalDate) : List<RecyclingPickupRequest>
